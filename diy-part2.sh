...
git clone https://github.com/YL2209/default-settings.git package/default-settings
...
sed -i "s/OpenWrt /编译时间 $(TZ=UTC-8 date "+%Y.%m.%d") @ 星新课代表制作出品 /g" package/lean/default-settings/files/zzz-default-settings
...
# sed -i 's/ssid=OpenWrt/ssid=MiWIFI_R4A/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

# 修改默认wifi密码key为password
# sed -i 's/encryption=none/encryption=psk2/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
# sed -i '/set wireless.default_radio${devidx}.encryption=psk2/a\set wireless.default_radio${devidx}.key=66666666' package/kernel/mac80211/files/lib/wifi/mac80211.sh
